...
class Game():
    ...
    menuindex = 0
    upgradeitems = ["back", "single button", "shotgun","shotgun dispersal", "machine gun","rocket", "sniper",
...
class Viewer(object):
    ...
    def run(self):
        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                # ------- pressed and released key ------
                    ...
                    if event.key==pygame.K_1:
                        ...
                        Flytext(500,400,"single")
                    
                    if event.key==pygame.K_2:
                        self.player1.firemode="shotgun"
                        Flytext(500,400,"shotgun")   
                    # ------ salvo player 1 -----
            ...
            write(self.screen, "points: {}:{}".format(self.player1.points, self.player2.points ), x=500, y=10)
            ...
            for mi in self.minegroup:
                ...
                for mo in crashgroup:
                    ...
                    Fireball(pos=mi.pos, bossnumber=self.mine.bossnumber)####
                    mi.kill()
            ...
            if oldleft and not left:
                 ...
                 #---auswertung upgrade------
                     ...
                     if self.activeplayer.points >= price:
                         ...
                         self.activeplayer.effect_shots_per_salvo +=1 
                         Flytext(500,400, "new salvo effect: {}".format(self.activeplayer.effect_shots_per_salvo))
                     else:
                     ...
                     if self.activeplayer.points >= price:
                         self.activeplayer.points -= price
                         self.activeplayer.effects_shots_per_salvo +=1
                         Flytext(500,400, "new salvo effect: {}".format(self.activeplayer.effect_shots_per_salv))
                     else:
                         Flytext(500, 400, "not enough money")
                     ...
                     if self.activeplayer.points >= price and self.activeplayer.shotgunangle <360:
                         ...
                         Flytext(500, 400, "shotgun dispersal +5")
                     else:
