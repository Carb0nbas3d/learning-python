...
class Game():
    ...
    menuindex = 0
    upgradeitems = [ "single shot", "shotgun", "mashine gun","rocket", "sniper"]
...
class PygView(object):
    ...
    def menurun(self):
        ...
        while running:
            ...
            # --- menu !!!! ----
            write(self.screen, "Menu", x=400, y=10,color=(255,0,255),
                  fontsize=48, center=True)
            for a,m in enumerate(Game.menuitems):
                write(self.screen, m , x=300, y=100+a*50, color=(1,1,1),
